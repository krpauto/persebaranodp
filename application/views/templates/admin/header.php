    ...
    <div id="sidebar" class="tm-sidebar-left uk-background-default">
        ...
        <ul class="uk-nav uk-nav-default">
            ...
            <li <?php if ($menu == "beranda") {
                ?> class="uk-active" <?php
                                    } ?>><a href="<?= base_url('admin') ?>"><span data-uk-icon="icon: home" class="uk-margin-small-right"></span>BERANDA</a></li>
            <li <?php if ($menu == "bencana") {
                ?> class="uk-active" <?php
                                    } ?>><a href="<?= base_url('admin/bencana') ?>"><span data-uk-icon="icon:  world" class="uk-margin-small-right"></span>PETA BENCANA</a></li>
            <li <?php if ($menu == "pelanggan") {
                ?> class="uk-active" <?php
                                    } ?>><a href="<?= base_url('admin/pelanggan') ?>"><span data-uk-icon="icon:  world" class="uk-margin-small-right"></span>PETA PELANGGAN</a></li>
            <li <?php if ($menu == "biodata") {
                ?> class="uk-active" <?php
                                    } ?>><a href="<?= base_url('admin/biodata') ?>"> <span data-uk-icon="icon: file-text" class="uk-margin-small-right"></span>BIODATA</a></li>
            <?php
            if ($this->session->userdata('status') == "admin") {
            ?>
                <li <?php if ($menu == "users") {
                    ?> class="uk-active" <?php
                                        } ?>><a href="<?= base_url('admin/users') ?>"><span data-uk-icon="icon: users" class="uk-margin-small-right"></span>USERS</a></li>
            <?php
            }
